...
<div class="shade">
    ...
    <div class="register logn">
        ...
        <ul>
            <li><input id="register_username" type="text" placeholder="用户名"></li>
            <li><input id="register_password" type="password" placeholder="密码"></li>
            <li><input id="register_mobile" type="text" placeholder="手机号"></li>
            <li><input id="register_code" type="text" class="yanzheng" placeholder="验证码"><span><img src="/images/login/yanzheng.png" alt=""></span></li>
            <li><input id="register_sms" type="text" class="verification" placeholder="短信验证码"> <a class="send" href="javascript:;">获取验证码</a></li>
            <p class="d_title">您输入的短信验证有误，请从新输入</p>
            <li><button class="btn" onclick="registerData()">注 册</button></li>
        </ul>
    </div>
</div>
